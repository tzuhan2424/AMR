...
def _work(process_id, infer_dataset, args):
    ...
    for iter, pack in enumerate(infer_data_loader):
        ...
        cam_dict = np.load(args.cam_out_dir + img_name[23:-4] + '.npy', allow_pickle=True).item()
        ...
        out.save(args.ir_label_out_dir + img_name[23:-4] + '_palette.png')
        imageio.imwrite(args.ir_label_out_dir + img_name[23:-4] + '.png',
