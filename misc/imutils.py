...
def random_resize_long(img, min_long, max_long):
    ...
    """
    the purpose of the all this resize, is to make sure the large side is 
    the target_long size. say have a img[200, 400], and you pick a random target_long is 500
    the result of the img will be [250 ,500]
    """

    target_long = random.randint(min_long, max_long) #[320 , 640]
    h, w = img.shape[:2]
